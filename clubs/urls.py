...
urlpatterns = [
    ...
    path('club/edit', views.edit_club, name='edit_club'),
    path('club/remove', views.remove_club, name='remove_club'),
    path('club/detail/<int:club_id>/', views.detail_club, name='detail_club'),
    path('club/apply', views.apply_club, name='apply_club'),
    path('club/leave', views.leave_club, name='leave_club'),
    path('club/accept', views.accept_club, name='accept_club'),
    path('club/reject', views.reject_club, name='reject_club'),
